// PublicCourses.jsx — Public Course Catalog
// Route: /courses
// No auth required. Enroll → /signup. SEO-friendly with slugs.
...
// ── Slug generator (mirrors detail page exactly) ──────────────────────────
...
export default function PublicCourses() {
  ...
  const filtered = courses
    ...
    .filter(c => !search || [c.title, c.description, c.category]
  ...
  return (
    <>
      <Helmet>
        <title>Online Courses | AIDLA — Learn, Earn & Grow</title>
        <meta name="description" content="Browse free and paid online courses on AIDLA. Learn Mathematics, Science, English, Computer Science and more. Earn coins and certificates as you learn." />
        <meta name="keywords" content="AIDLA courses, free online courses Pakistan, learn online, earn coins, certificates, mathematics, science, English" />
        <meta property="og:title" content="Online Courses — AIDLA" />
        <meta property="og:description" content="Browse expert-led courses, earn coins, and get verified certificates on AIDLA — Pakistan's #1 educational rewards platform." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.aidla.online/courses" />
        <meta property="og:image" content="https://www.aidla.online/og-home.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <link rel="canonical" href="https://www.aidla.online/courses" />
      </Helmet>
      ...
      <div className="pc-root">
        {/* Orbs */}
        <div className="pc-orb1" /><div className="pc-orb2" /><div className="pc-orb3" />
          ...
          <div className="pc-hero-inner">
            ...
            {!loading && courses.length > 0 && (
              <div className="pc-stats pc-fade">
                ...
                <div className="pc-stat-div" />
                <div className="pc-stat">
                  <div className="pc-stat-val">{[...new Set(courses.map(c => c.category).filter(Boolean))].length || "10+"}</div>
        ...
        <main className="pc-main">
          ...
          <div className="pc-filters">
            ...
            <select className="pc-sort" value={sort} onChange={e => setSort(e.target.value)}>
  ...
  return (
    ...
    >
      ...
      <div className="pc-card-body">
        ...
        <p className="pc-card-desc">{course.description || "Explore this course to discover what you'll learn."}</p>

        <div className="pc-card-footer">
          <div className="pc-card-info">
            {course.certificate_price > 0 ? "🏆 Certificate available" : ""}
          </div>
          <Link to={`/courses/${slug}`} className="pc-btn-view">
            Details →
          </Link>
          <Link to="/signup" className="pc-btn-enroll">
