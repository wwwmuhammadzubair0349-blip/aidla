// MyCertificates.jsx — User Certificates Vault
// Shows all earned certificates, download PDF, share, view
// Add this as a tab in the Profile page
...
export default function MyCertificates() {
  ...
  // Download PDF — opens the certificate print page
          ...
          return (
            ...
            >
              ...
              <div style={{
                ...
                <div style={{ fontSize: 10, fontWeight: 700, color: 'rgba(255,255,255,.6)', textTransform: 'uppercase', letterSpacing: 2, marginBottom: 6 }}>
                  Certificate of Completion
                </div>
                <div style={{ fontFamily: "'Instrument Serif', serif", fontStyle: 'italic', fontSize: 20, color: C.white, lineHeight: 1.3, marginBottom: 4 }}>
                  {cert.course?.title || '—'}
                </div>
                {(cert.course?.level || cert.course?.category) && (
                ...
                <div style={{
                  ...
                  background: `conic-gradient(${C.amber} 0deg, #F0C040 120deg, ${C.amber} 240deg, #F0C040 360deg)`,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  boxShadow: `0 0 0 3px ${C.white}, 0 0 0 5px ${C.amber}`,
                  zIndex: 2,
                }}>
              ...
              <div style={{ padding: '22px 20px 16px' }}>
                ...
                <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                  ...
                  <button
                    ...
                    onClick={() => navigate(`/user/certificate/${cert.id}`)}
