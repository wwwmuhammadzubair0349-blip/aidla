// cv/Preview.jsx
// ALL live-preview UI lives here: zoom controls, accent/font/paper/size pickers, download button.
// CSS is inlined — no separate Preview.css needed.
// Print logic stays in Print.jsx — we just call it from here.
...
export default function Preview({
  ...
  return (
    <>
      ...
      {/* ── Controls strip (accent / font / size / paper) ── */}
      <div className="cv-prev-ctrls">

        {/* Accent colour */}
        <div className="cv-ctrl-row">
          <span className="cv-ctrl-lbl">Colour</span>
        ...
        {/* Paper */}
        <div className="cv-ctrl-row">
          <span className="cv-ctrl-lbl">Paper</span>
          <div className="cv-tog-g">
