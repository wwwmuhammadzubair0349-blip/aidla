      ...
      >
        ...
        <div style={{ padding:"14px 14px 12px", flex:1, display:"flex", flexDirection:"column", gap:8 }}>
          ...
          <div style={{
            ...
            paddingTop:8, borderTop:"1px solid #f8fafc", marginTop:4,
          }}>
...
export default function ResourcesPage() {
  ...
  const applyFilters = (newFilters, newPage = 1) => {
    ...
    if (newFilters.university)   params.university = newFilters.university;
    if (newFilters.class_level)  params.class      = newFilters.class_level;
      ...
      <div style={{ minHeight:"100vh", background:"#f8fafc", fontFamily:"'DM Sans',sans-serif" }}>
            ...
            <div style={{ position:"relative", maxWidth:540, margin:"0 auto 18px" }}>
              ...
              {filters.search && (
                <button onClick={handleReset}
                  style={{ position:"absolute", right:12, top:"50%", transform:"translateY(-50%)", background:"none", border:"none", cursor:"pointer", fontSize:17, color:"#94a3b8" }}>
                  ✕
                </button>
              )}
            </div>
        ...
        <div style={{ maxWidth:1300, margin:"0 auto", padding:"20px 14px 48px" }}>
          ...
          <button className="res-filter-fab"
            ...
            🔍 Filters
            {hasFilters && (
              <span style={{ background:"#1a3a8f", color:"#fff", borderRadius:12, padding:"1px 7px", fontSize:11 }}>●</span>
            )}
          </button>
          ...
          <div className="res-filter-drawer" style={{
            position:"fixed", left:0, top:0, bottom:0,
            width:"min(88vw,310px)", zIndex:1000,
            overflowY:"auto", padding:14, background:"#f8fafc",
            ...
            <FilterSidebar
              ...
              total={total} isMobile onClose={() => setShowFilter(false)}
            />
          </div>
          ...
          <div className="res-layout">
            ...
            <div>
              ...
              <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:12, flexWrap:"wrap", gap:8 }}>
                ...
                {hasFilters && (
                  <button onClick={handleReset}
                    style={{ fontSize:12, color:"#dc2626", background:"rgba(239,68,68,0.06)", border:"1px solid rgba(239,68,68,0.15)", borderRadius:6, padding:"4px 10px", cursor:"pointer", fontWeight:700 }}>
                    ✕ Clear all filters
                  </button>
                )}
              </div>
              ...
              {loading ? (
                ...
                <div style={{ textAlign:"center", padding:"52px 20px", border:"2px dashed #e2e8f0", borderRadius:16 }}>
                  ...
                  <button onClick={handleReset}
                    style={{ padding:"10px 24px", background:"linear-gradient(135deg,#1a3a8f,#3b82f6)", color:"#fff", border:"none", borderRadius:10, fontWeight:700, cursor:"pointer" }}>
                    Clear filters
                  </button>
                </div>
              ) : (
              ...
              {totalPages > 1 && !loading && (
                <div style={{ display:"flex", justifyContent:"center", alignItems:"center", gap:6, marginTop:28, flexWrap:"wrap" }}>
                  <button
                    onClick={() => { const p = Math.max(1,page-1); setPage(p); load(filters,p); }}
                    disabled={page===1}
                  ...
                  <button
                    onClick={() => { const p = Math.min(totalPages,page+1); setPage(p); load(filters,p); }}
