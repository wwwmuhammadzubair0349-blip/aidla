...
export default function Login() {
  ...
  // 2) Real-Time User Existence Check & Name Fetching
  useEffect(() => {
    const fetchUserNameAndCheck = async () => {
      ...
      <div className="card-2060">
        ...
        <form onSubmit={onSubmit}>
          <div className="input-group">
            ...
            />
            {userNotFoundMsg && <span className="error-text">{userNotFoundMsg}</span>}
          </div>
          ...
          <div className="links-row">
            <Link to="/forgot-password" className="link-3d">Forgot password?</Link>
            <Link to="/signup" className="link-3d">New here? <span>Create Account</span></Link>
          </div>

          {msg && (
            <div className="msg-box" style={{ color: "#b91c1c", background: "#fee2e2", boxShadow: "inset 0 0 0 2px #f87171" }}>
              {msg}
            </div>
          )}
        </form>
