// AdminCourses.jsx — AI-Powered Admin Panel
// Features: AI Course Generator · AI Article Writer · AI Quiz Generator
//           AI Assignment Creator · AI Improve · YouTube Player · YouTube Suggester
...
const callCoursesAI = async (action, payload) => {
  const res = await fetch(
    `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/courses-ai`,
    {
      method: 'POST',
